...
### Versions:
   ...
   - 0.1.0.0<br> 
             added mod support<br> 
             added humanskin loading form game resources<br>
             added the ability to create make humanskin from elements of any faction<br>
             added models LOD overview<br> 
             changed save principle<br>
             changed resource loading principle<br>
             removed fraction system, all resource show together now<br>
...
### Roadmap:
- [x] Connecting resources from modifications along with game ones;
- [x] Loading existing skins from the game without unpacking them;
- [x] Ability to combine elements of different factions;
- [ ] More flexibility in saving skins;
- [ ] Localization of the application to EN, RU and DE;
- [ ] Adding overview some environment on humanskin (helmets, masks, body armor).
...
### Версии:
   ...
   - 0.1.0.0 <br>
             добавлена поддержка модов<br>
             добавлена загрузка Humanskin из игровых ресурсов<br>
             добавлена возможность сохранения Humanskin из элементов разных фракций<br>
             добавлен обзор LOD-моделей<br>
             изменен принцип сохранения<br>
             изменен принцип загрузки ресурсов<br>
             удалена система фракций теперь все ply ресурсы отображаются вместе, без разделения<br>
...
Примечания:
  ...
  или "Load textures" если нет текстур в окне их выбора.
...
### Дорожная карта:
- [X] Подключение ресурсов из модификаций вместе с игровыми;
- [X] Загрузка существующих скинов из игры без их распаковки;
- [X] Возможность совмещать элементы разных фракций;
- [ ] Больше гибкости в сохранении скинов;
- [ ] Локализация приложения на EN, RU и DE;
- [ ] Добавление просмотра различных элементов окружения на скинах (каски, маски, бронежилеты).
