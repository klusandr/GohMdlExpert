...
namespace GohMdlExpert.Models.GatesOfHell.Exceptions {
    public class GohResourcesException : GohException {
        ...
        public GohResourcesException() : base(GetFullErrorMessage()) {}

        public GohResourcesException(string message) : base(GetFullErrorMessage(message)) { }

        public GohResourcesException(string message, Exception inner) : base(GetFullErrorMessage(message), inner) { }
